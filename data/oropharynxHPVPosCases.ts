...
export const oropharynxHPVPosCases = [
  ...
  // -------------------------
  {
    ...
    stem: { age: 51, sex: "male", risk: "none", symptom: "painless neck mass", laterality: "right" },
    tumor: { size_cm: 0, advanced_local_extension: false },
  ...
  },
  {
    ...
    site_group: "oropharynx",
    subsite: "unknown_primary",
    stem: { age: 45, sex: "male", risk: "none", symptom: "rapidly enlarging neck mass", laterality: "left" },
    tumor: { size_cm: 0, advanced_local_extension: false },
  ...
  },
  {
    ...
    site_group: "oropharynx",
    subsite: "unknown_primary",
    stem: { age: 42, sex: "male", risk: "none", symptom: "neck mass after URI", laterality: "right" },
    tumor: { size_cm: 0, advanced_local_extension: false },
  ...
  },
  {
    ...
    site_group: "oropharynx",
    subsite: "unknown_primary",
    stem: { age: 57, sex: "female", risk: "none", symptom: "neck mass", laterality: "left" },
    tumor: { size_cm: 0, advanced_local_extension: false },
  ...
  },
  {
    ...
    site_group: "oropharynx",
    subsite: "unknown_primary",
    stem: { age: 65, sex: "male", risk: "both", symptom: "neck mass with otalgia", laterality: "right" },
    tumor: { size_cm: 0, advanced_local_extension: false },
  ...
  },
  {
    ...
    site_group: "oropharynx",
    subsite: "unknown_primary",
    stem: { age: 50, sex: "male", risk: "none", symptom: "cystic neck mass", laterality: "left" },
    tumor: { size_cm: 0, advanced_local_extension: false },
